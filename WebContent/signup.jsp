...
<table>
	...
	<tr>
		...
		<td>
			<label class="radio" style="display: inline-block;color:#FFF"><input type="radio" name="gender" id="Male" value="m" checked>Male</label>
			<label class="radio" style="display: inline-block;color:#FFF"><input type="radio" name="gender" id="Female" value="f">Female</label>
		</td>
	</tr>
	<tr>
		<td>
		...
		<!-- a href="javascript:NewCal('inputDob','ddmmmyyyy',true,24)" style="padding-left: 0px;"><input  name="dob" id="inputDob"  type='text'  placeholder="Date Of Birth"  onfocus='blur()' /></a -->
			<input type="text"  name="dob" id="inputDob" placeholder="Date Of Birth" />
	...
	<tr>
		...
		<td>
			<input type="text" id="inputEmail" name="inputEmail" placeholder="Email Id">
	...
	<tr>
		<td>
			<label class="label-name">Passout Year :</label>
		</td>	
		<td>
			<select style="width:195px;height:28px;" id="inputPassyr" class="box" name="inputPassyr">
	...
	<tr>
		<td>
			<label class="label-name">Branch :</label>
		</td>	
		<td>
			<select style="width:195px;height:28px;" class="box" id="selectBranch" name="branch">
				<option selected>-select-</option>
			</select>
			<div class="bubble" id="emptyBrach"><span style="color:#FFF">*Select Branch.</span></div>
		</td>
	</tr>
	<tr>
		<td>
			<label class="label-name">Enrollment Id :</label>
		</td>	
		<td>
			<input type="text" id="inputEnrno" name="inputEnrno" placeholder="Enrollment Id">
	...
	<tr>
		<td colspan="2">
			<center><input type="submit" class="btn" id="signup_btn" value="Sign Up"></center>
		</td>	
	</tr>
