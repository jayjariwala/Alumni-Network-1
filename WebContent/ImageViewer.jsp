...
<div class="bg-content"  style="width:100%;;height:100%;background-color:#F9F5ED"">       
  <!-- Content -->      
    ...
    <div class="container">
        <div class="row">
        	<div style="display:inline">
                ...
                <a href="Gallery.jsp">
              	<img src="img/back1.png" height="50" width="50" >
                </a>
                 </div>
...
if(resultFlag!=null && !"".equals(resultFlag) )
{
	...
	if(resultFlag.equals("1"))
	{
		...
		<table > <tr> <th bgcolor="#FFFF99"> <font color="red"> Please Specify Picture Title! </center>  </th></tr></table>
	...
	if(resultFlag.equals("2"))
	{
		...
		<table > <tr><th bgcolor="#FFFF99"> <font color="red"> Please Select Permisson</font>  </th></tr></table>
	...
	if(resultFlag.equals("3"))
	{
		...
		<table > <tr><th bgcolor="#FFFF99"> <font color="red"> Please Specify Caption </font>  </th></tr></table>
	...
	if(resultFlag.equals("4"))
	{
		...
		<table > <tr><th bgcolor="#FFFF99"> <font color="red">	You must Specify date</font>  </th></tr></table>
	...
	if(resultFlag.equals("5"))
	{
		...
		<table><tr><th bgcolor="#FFFF99"> <font color="red">You must Specify Time</font>  </th></tr></table>
	...
	if(resultFlag.equals("6"))
	{
		...
		<table><tr><th bgcolor="#FFFF99"> <font color="red">You must specify Image</font>  </th></tr></table>
	...
	if(resultFlag.equals("7"))
	{
		...
		<table > <tr><th bgcolor="#FFFF99"> <font color="red">Upload jpg/png/jpeg image only!</font>  </th></tr></table>
	...
	if(resultFlag.equals("10"))
	{
		...
		<table > <tr><th bgcolor="#FFFF99"> <font color="red">All The Details are compalsory</font>  </th></tr></table>
...
$(document).ready(function() {
	$( "#photos" ).submit(function( event ) {
		...
		return true;
         ...
         <div style="margin-top:100px;
           ...
           <form enctype="multipart/form-data" id="photos" method="post" action="PhotosUplodSERVELET"> 
           <table > <tr> <th bgcolor="#FFFF99" id="errMsg" style="margin:10px">  </th></tr></table>
            <h5 style="color:#000;font-weight:normal;display:inline">&nbspPicture Title&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="aalbum_name" id=album_name></h5>
           <h5 style="color:#000;font-weight:normal;display:inline;margin-left:70px">Privacy &nbsp;:&nbsp;&nbsp;</h5>
    <select id="privacy" name="privacy">
          ...
          <h5 style="color:#000;font-weight:normal;display:inline; margin-left:5px">Caption &nbsp;:&nbsp;&nbsp;&nbsp;</h5>
          <textarea name="caption" style="margin-left:20px" id="caption"></textarea>
          
          <br/>
          
          <h5 style="color:#000;font-weight:normal;display:inline;margin-left:5px">Taken date &nbsp;:</h5>
          <input type="date" id="date" name="Date" style="margin-left:10px">
         
            <h5 style="color:#000;font-weight:normal">&nbspAlbum picture&nbsp;:&nbsp;&nbsp;&nbsp;<input type="file" name="images" >
   			<input type="hidden" value="<%=A_id%>" name="Album_id">     
           
           <input type="submit" value="save" id="post-save" style="margin-left:15px"></h5>
             </form>
             <br/>
             <br/>
       ...
       <a href="DeletePicServlet?value=<%=bean.getPhoto_id()%>&a_id=<%=A_id%>" >
    ...
    <a href="<%=bean.getImagepath()%>" class="abc" >
	<img src="<%=bean.getImagepath()%>"  style="height:192px;width:270px" alt="" />
	<div class="tm_mask tm_mask-1"></div>
	<div class="tm_mask tm_mask-2"></div>
	<div class="tm_content">
		<p> <%=bean.getPerm_name() %><br/><br/>
			Uploaded By: <%=bean.getF_name()%> <br/><br/>
