...
<body>
<div class="tab-content" style="position: inherit;padding-bottom:300px;">
	<div id="help-spt">
		<label class="tab-title">Help/Support</label><br />
			<table cellpadding="5" cellspacing="10" width="50%" height="100px" style="margin-left: 200px;" >
				<tr>
                	<th>No</th>
					<th>Email_Id</th>
					<th>Message</th>
				...
				{ 
					...
					{
						%>		
						<font align="center" color="Green"> Message sent successfully!</font>  
				 <%
					} 
				}
				...
				{ 
					%>
					<table><tr><th>No Messages</th> </tr></table>
				<%
				}
				else
				{ 
				...
				<tr>
					...
					<td style="max-width: 200px;overflow: auto;white-space: pre-wrap;"><%=bean.getMessage()%></td>
                    <td><a href="DeteteHelpandSupportSERVELET?param=<%=bean.getH_id()%>"><img src="images/delete.png"></a></td>
                    <td>&nbsp; &nbsp;</td>
                    <td><input type="button" name="Reply" value="Reply"  id="Reply"></td>
