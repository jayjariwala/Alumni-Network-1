		...
		<tr class="colname">
			<table width="100%" class="table table-hover">
                <tr style="color:#EA8C2D;">
                    ...
                    <th colspan="3" style="text-align:center;">Reported by <hr /></th>
                    <th colspan="2" style="text-align:center;">Action<hr /></th> 
                </tr>
				...
				if(!StringUtils.isEmptyOrWhitespaceOnly(flag)||!StringUtils.isNullOrEmpty(flag))
				{
					if(flag=="1")
					{
						%>
					...
					if(list==null)
					{
						%>
						<tr>
						<td colspan="7" style="text-align:center;"><center><b><%="No data!" %></b></center></td>
						</tr>
						<%	
					}
					else
				...
				<tr>
					...
					<td colspan="3" style="text-align:center;" >
						...
						<tr>
							...
							<td style="text-align:center;"><a href="#"><%= rtrub1.getReporter_fname() %> &nbsp;<%= rtrub1.getReporter_lname() %></a></td>
					...
					<td style="text-align:center;">
						<form id="form1" name="form1" method="post" action="ReportedUserWarnSERVLET?user=<%=rtdub1.getReported_Id() %>" >
							<textarea id="warnTextArea<%=i%>" style="resize:none" name="warning_msg" rows="5" cols="25" name="warn" ></textarea>
							<div id="warndiv<%=i%>">This field is required!</div>
							<br />
							
						</form>
						<button id="post-btn" value="Send" tpye="submit" class="warnbutton<%=i%>">Send</button>
					</td>
					<td style="text-align:center;">
						<form id="form2" name="form2" method="post" action="ReportedUserBanSERVLET?user=<%=rtdub1.getReported_Id() %>" >
							<button name="ban" type="button" id="ban" type="submit" >Ban User</button>
						</form>
					</td>
				</tr>    
				<%
