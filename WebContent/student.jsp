...
color: #000;
 ...
 <div class="content">
   <%
       ...
       {%>
       			<table align="center"> <tr> <th bgcolor="#211C19"><font color="red">You already reported this Student!</font>  </th></tr></table>    
        		
       
      <% } if(resultFlag.equals("2")){     
    	%> 	  
    	<table align="center"> <tr> <th bgcolor="#211C19"><font color="#11DA00">Student is Reported...</font>  </th></tr></table>    
    	
     <% } if(resultFlag.equals("3")){
    	 %><table align="center"> <tr> <th bgcolor="#211C19"><font color="red">Try again!</font></th></tr></table>
    	 <%
     }
       } %>
  ...
  <div class="main" style="border-top-right-radius: 50px;border-bottom-left-radius: 50px;margin-left: 10px;margin-right: 10px;margin-bottom: 20px;padding: 20px;">
   <%String id = request.getParameter("id"); %>
      <form name="profile-action" action="ReportstudentSERVLET?id=<%=id%>" method="post" >
        ...
        <% 
        	ProfileBEAN bean = (ProfileBEAN) request.getAttribute("Profilebean"); 
             //   String 123 = (String) request.getParameter("id");
        ...
        %>
            <h1><b><%=lname%> <%=fname%> <%=mname%></b></h1>
              <button type="button" class="btn" id="mod_btn" >Report</button>
        	<div>
        	<label class=label id=issmse style="float:right;" >Issus Massage:</label><input type=text class="edit" name="msg" ></input>
           <button type="submit" class="btn" id="edit_btn" >Report</button>  
             </div>
            </td>
          </tr>
          <tr>                	
          ...
          <tr>
            <td width="50%" height="812" style="border-right:0.5px groove #A0A0A4;padding-right:25px;height:500px;"><table width="100%" height="125%">
              <tbody>
                <tr>
                  <td colspan="2">&nbsp;</td>
              	</tr>
                ...
                <tr>
                  <td><span class="tm_image_reflection" ><img src="<%=picpath %>" width="160" height="200"/></span><br /></td>
                  <td>
               <table width="100%">
                 <tr>
                   <td>
                 ...
                 <td>
                   ...
                   <label class="value"><%=user %></label>

                   </td>
                 </tr>
                 <tr>
                   <td><label class="label" ><b> </b></label></td>
    	           <td><label class="value" ></label>
           ...
           <tr>
             ...
             <td>
             <%if(lname.equals(null)){%><label class="value"></label><%}else{ %>
             <label class="value"><%=lname%></label><%}%>
             <%if(fname.equals(null)){ %><label class="value"> </label><%}else{ %>
               <label class="value"><%=fname%></label><%}%>
              <%if(mname.equals(null)){%><label class="value"></label><%}else{ %>
               <label class="value"><%=mname%></label><%} %>
         ...
         <tr>
           ...
           <td><label class="value"><%=gender%></label>
     	 ...
     	 <tr>
           ...
           <td><label class="value"><%=dat %></label>
         ...
         <tr>
           ...
           <td>
           <%if(mobileno.equals(null)){ %><label class="value" ></label><%}else{ %>
         ...
         <tr>
           ...
           <td><label class="value"><%=email%></label>
             </td>
         </tr>
         <tr>
           <td><b>
 ...
 %>	 <label><%=hobbiesname %>,
       ...
       <table>
         <tr>
           ...
           <td>
           <%if(add1.equals(null)){ %><label class="value"></label><%}else{ %>
           <label class="value"><%=add1%></label><%} %>
           </td>
         </tr>
         <tr>
           <td><b>
           ...
           <td>
           <%if(add2.equals(null)){ %><label class="value"></label><%}else{ %>
           <label class="value"><%=add2%></label><%} %>
    ...
    <table width="100%" id="add_job_btn">
      <tr>
        <td colspan="2"><legend class="main-heading">Education Details :</legend>
        </td>
      </tr> 
      <%
       ...
       %> <tr>
        <td><b><label class="label">Highest Education :</label></b></td>
		<td>
          <table width="100%">
            ...
            <tr>
              <td><b><label class="label">College/Institute :</label></b></td>
      ...
      <tr>
		...
		<td>
          <table width="100%">
            ...
            <tr>
              <td><b><label class="label">College/Institute :</label></b></td>
              <td><label class="value"><%=educationclgname %> </label></td>
		    </tr>
  ...
  <%
     ...
     <tr>
          ...
          if(othereducation==null){
           ...
           <tr>
             <td><b><label class="label">Branch(cource Name) :</label></b>
               <td><label class="value"> <br /></td></label>
		       </td>
           ...
           <tr>
             <td><b><label class="label">Branch(cource Name) :</label></b>
               <td><label class="value"><%=othereducationcourse %> <br /></td></label>
		       </td>
      ...
      <tr>
        ...
        <hr />
          ...
          <legend class="main-heading">Professional Details :</legend>
    	</td>
	  </tr>
      <tr>
        <td><b><label class="label">Total Experience:</label></b>
        </td>
        <td><label class="value"><%if(totexpyear.equals(null)){ %><span class="year">-</span><%}else{ %><span class="year"><%=totexpyear %></span><%} %> Year <%if(totexpmonth.equals(null)){ %><span class="month"></span><%}else{ %><span class="month>"><%=totexpmonth %></span><%} %> Month</label>     
		</td>
      </tr>
      <tr>
 		<td><b><label class="label">Key Skill :</label></b></td>
        <td>
        <%if(keyskills.equals(null)){ %><label class="value">no keyskills</label><%}else{ %><label class="value"><%=keyskills %></label><%} %>
      ...
      List<JobBean> job = bean.getJob();
          ...
          <table width="100%">
	        <tr>
		      ...
		      <td><label class="value">no Job data</label>
        ...
        <hr />
          <table width="100%">
	        <tr>
		      ...
		      <td><label class="value"><%=jobtype %></label>
        	...
        	<td><label class="value"><%=industryname %></label>
          ...
          <tr>
            ...
            <td><label class="value"><%=functionarea %></label>
            </td>
          </tr>
		</table>
		<%
