...
color: #000;
 ...
 <div class="content">
   <%
       ...
       {%>
       			<table align="center"> <tr> <th bgcolor="#211C19"><font color="#11DA00">Request sent!</font>  </th></tr></table>    
        		
       
      <% } if(resultFlag.equals("1")){     
    	%> 	  
    	<table align="center"> <tr> <th bgcolor="#211C19"><font color="red">You have already sent request</font>  </th></tr></table>    
    	
     <% } if(resultFlag.equals("21")){
    	 %><table align="center"> <tr> <th bgcolor="#211C19"><font color="#11DA00">Profile Updated!</font></th></tr></table>
    	 <%
     }
       } %>
  ...
  <div class="main" style="border-top-right-radius: 50px;border-bottom-left-radius: 50px;margin-left: 10px;margin-right: 10px;margin-bottom: 20px;padding: 20px;">
      ...
      %>
             <a href="SendRequestToBecomeMod"> <button type="button" class="btn" id="mod_btn" >Become moderator</button> </a>
             <%}  %>
            </td>
          </tr>
          <tr>                	
