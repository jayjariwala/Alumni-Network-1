...
public class UserAppDAO {
	...
	public List<UserAppBEAN> displayListOfApp() throws SQLException {
		...
		{		
			...
			PreparedStatement ps = con.prepareStatement("SELECT doc_Id,members.f_name,members.enr_No,data,date_time,sub,pannding FROM doc_req,members where(doc_req.m_Id=members.m_Id)AND(pannding=1);");
