...
public class ProfileBEAN
{
	...
	/*
	private String otherEdBranch;
	private String otherEdCource;
	private String otherEdPassOutYear;
	private String otherEdCollegeNameOrInst;
	*/
...
/*	
	...
	public String getOtherEdBranch() {
		return otherEdBranch;
	}
	public void setOtherEdBranch(String otherEdBranch) {
		this.otherEdBranch = otherEdBranch;
	}
	public String getOtherEdCource() {
		return otherEdCource;
	}
	public void setOtherEdCource(String otherEdCource) {
		this.otherEdCource = otherEdCource;
	}
	public String getOtherEdPassOutYear() {
		return otherEdPassOutYear;
	}
	public void setOtherEdPassOutYear(String otherEdPassOutYear) {
		this.otherEdPassOutYear = otherEdPassOutYear;
	}
	public String getOtherEdCollegeNameOrInst() {
		return otherEdCollegeNameOrInst;
	}
	public void setOtherEdCollegeNameOrInst(String otherEdCollegeNameOrInst) {
